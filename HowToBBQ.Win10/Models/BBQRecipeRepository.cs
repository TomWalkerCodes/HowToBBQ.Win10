...
{
    public class BBQRecipeRepository : IBBQRecipeRepository
    {

        private List<BBQRecipe> bbqRecipes = new List<BBQRecipe>();
        private int _nextId = 1;


        public BBQRecipeRepository()
        {
            LoadBBQRecipes();
        }
        ...
        public IEnumerable<BBQRecipe> GetAll()
        {
            return bbqRecipes;
        }
